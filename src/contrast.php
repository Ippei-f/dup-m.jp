...
.maintitle3{margin-bottom:3em;}
.maintitle1 img{max-width:806px; margin:auto;}
.maintitle3 img{max-width:796px; margin:auto;}
.maintitle4{
	width:12em;
	margin:auto;
...
@media screen and (min-width: 800px) {
	.maintitle1{margin-bottom:2.75em;padding-bottom: 2.75em;}
	.maintitle3{margin-top:2.5em;}
}
@media screen and (max-width: 799px) {
	.maintitle1{margin-bottom:2em;padding-bottom: 2em;}
	.maintitle3{margin-top:1em;}
	.maintitle1 img{max-width:80%;}
	.maintitle3 img{max-width:100%;}
}
...
.bg_kokogachigau table tr > *{vertical-align:middle; text-align:left;}
.bg_kokogachigau table tr > *:nth-child(1){width:7.5em;}
.bg_kokogachigau table tr > *:nth-child(1) img{width:100%;}
...
.box_iitokoro{}
.box_iitokoro li:nth-child(2n+2) img{margin:auto;}
.box_iitokoro .iitoko_num{}
.box_iitokoro .iitoko_num tr > *{text-align:center; vertical-align:middle;}
.box_iitokoro .iitoko_num tr > *:nth-child(2){padding-left:1em;}
...
.box_iitokoro .iitoko_num tr > * img{height:4.5em;}
.box_iitokoro .kouhou{}
.box_iitokoro .kouhou tr > *{text-align:left; vertical-align:middle;}
@media screen and (min-width: 800px) {
	.box_iitokoro li{width:48%;}
	.box_iitokoro li:nth-child(2n+1){float:left; clear:both;}
	.box_iitokoro li:nth-child(2n+2){float:right;}
	.box_iitokoro li:nth-child(n+3){margin-top:4em;}
	.box_iitokoro .kouhou tr > *:nth-child(1){padding-bottom:1em;}
}
@media screen and (max-width: 799px) {
	.box_iitokoro li:nth-child(2n+2){margin-top:2em;}
	.box_iitokoro li:nth-child(2n+3){margin-top:4em;}
	.box_iitokoro li:nth-child(2n+2) img{width:80% !important;}
	.box_iitokoro .iitoko_num{margin:auto;}
	.box_iitokoro .kouhou tr > *:nth-child(1){padding-right:1em;}
}

.box_mameden{margin-top:3em;}
.box_mameden tr > *{text-align:left; vertical-align:top;}
.box_mameden tr > *:nth-child(1){width:1.5em;}
.box_mameden tr > *:nth-child(2){padding-left:0.75em;font-size:125%;}
...
@media screen and (max-width: 799px) {
	.box_mameden{width:80vw; margin-left:auto; margin-right:auto;}
	.box_mameden tr > *:nth-child(2){padding-left:0.5em; padding-top:0.125em;}
	.box_mameden tr > *:nth-child(2) span{font-size:90%;}
}

.box_voice{}
.box_voice li{}
.box_voice li table{margin:auto;}
.box_voice li .kao{width:120px;}
.box_voice li .pad{width:10px;}
.box_voice li .fuki{
	width:290px;
	text-align:left;
...
@media screen and (min-width: 1000px) {
	.box_voice{width:980px;}
	.box_voice li:nth-child(1){float:left;}
	.box_voice li:nth-child(2){float:right;}
}
@media screen and (max-width: 999px) {
	.box_voice li:nth-child(n+2){margin-top:1.5em;}
}
@media screen and (max-width: 799px) {
	.box_voice li .kao{width:21.875vw;}
	.box_voice li .fuki{width:53.125vw;}
}

.local_color_bg{padding:0 25px;}
.box_vs .text{font-size: 187.5%;}

@media screen and (min-width: 800px) {
	.bg_kokogachigau,
	.local_color_bg{margin-right:50px;}
	.btn_vs{width:740px;}
}
@media screen and (max-width: 799px) {
	.bg_kokogachigau table tr > *:nth-child(1){width:18%;}
	.bg_kokogachigau table tr > *:nth-child(2){
		padding-left:1em;
		font-size: 5vw;
	}
	.box_vs .text{font-size: 5vw;}
	.box_vs .text{width: 80%;}
	.btn_vs{width: 100%;}
}
...
.maintitle1_fuki{padding: 40px 0 30px;}
.maintitle1_fuki img{width:260px;}
.btn_bukken2022{
	margin: 70px auto;
	display: flex;
...
.btn_bukken2022.mgn0{margin:0 auto;}
.btn_bukken2022 a{
	display: block;
	width:414px;
	max-width: 100%;
}
.btn_bukken2022.bnrbox a{width: auto;}
.btn_bukken2022 a img{width:100%;}
.btn_yoyaku{margin-top: 115px;margin-bottom: 80px;}
...
.btn_yoyaku2 a{width:419px;max-width: 100%;}
.btn_yoyaku2 a img{width:100%;}
@media screen and (max-width: 799px) {
	.btn_yoyaku img:nth-child(1){width:600px;}
	.btn_bukken2022 a,
	.btn_yoyaku2 a{width:522px;max-width: 100%;}
}
.hikaku2022{
	margin: auto;
	margin-top: 90px;
...
.hikaku2022 img{margin-bottom: 0.75em;}
</style>
</head>
...
?>
<div class="bg_stripeY"><div class="content">
...
<div class="content">
<!-- *** -->
<div style="display: flex;justify-content: center;flex-wrap: wrap; margin-bottom: 2em;">
<?php
$bnrset_type='中古マンションタイトル下';
...
<div class="local_color" style="background-color:#004021; color:#FFF;"><div class="bg box_vs">
...
<div class="local_color_bg" style="background-color:#D3E2DA;"><div class="Wmax1100 mgnAuto">
