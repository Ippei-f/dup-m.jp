...
@media screen and (max-width: 799px) {
	.merit_catch{font-size:200%;}
	.merit_comment{font-size:120%;}
	.merit_comment.sp_textL{text-align:left;}
}
.meritbox1 li{
...
<?php
echo SPAN_IB('上下階で空間を専有するメゾネット構造は、
...
function MERIT1_BOX($num='',$title='',$text='',$img='',$maxw='auto',$rtext='',$pcpad=''){
	...
	if($num!=''){$num='<table border="0" cellpadding="0" cellspacing="0" class="num LH100"><tr>
<td class="fontP050">MERIT</td>
<td>'.$num.'</td>
</tr></table>
<div class="clear"></div>'.chr(10);}
	
	if($img!=''){$add=' class="floatL_pc"';}
	else{$add='';}
...
MERIT1_BOX($cnt++
,'命と暮らしを守る木造2×4工法'
,'2×4工法は木材を用いる建築工法の１つで、もともとアメリカを中心に普及した工法です。強い衝撃を壁・天井・床の6面全体で受け止めバランス良く吸収するため、水平・垂直、両方向からの力に優れた強さを発揮します。1995年の阪神淡路大震災時に、2×4工法の住宅は「96.8％が生活に支障なし。全壊・半壊はゼロ」という検証結果が出ており、地震に強い工法であることが証明されています。'.IMG_TAG($url,'W100per dpB sp_vanish','margin-top:1em;')
,'photo-1-4p.jpg','100%'
...
<div class="LH200">ロンドンの高級住宅地・チェルシー地区には、2戸連棟型の住まいが数多く見られます。一つの建物をちょうど中央から左右対称に区分したこの建築様式は、イギリスでは「セミ・デタッチドハウス※」と名付けられ、地価の高い都心部を中心に普及。便利で快適な都市の生活環境を、通常の一戸建てよりもリーズナブルに享受できます。この建築様式はアメリカにも伝わり、 DUPLEX（デュープレックス）と名付けられ今なお人気を博しており、海外では一般的に広く建てられています。</div></div>
...
ひとつの建物を2戸に活用するセミ・デタッチドハウスは、日本では「二軒長屋」と呼ばれ、江戸時代に広く普及しました。一棟の建物を中央で割った形となるため、それぞれの家に専用玄関と庭がつく点も特色です。イギリスでは子供を持つ家族が暮らすだけでなく、大学生が友人とシェアして住むケースも多く見られます。</div>
<div class="clear"></div>
</div>
</div>
<!-- ** -->
