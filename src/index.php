	...
	<div align="center">
		...
		<div class="index-kv">
			<div class="index-kv__list">
				...
				<div class="img-2">
					<img class="rellax pc-only" data-rellax-speed="1.5" src="images/top/index-kv-img-2.jpg" alt="" />
					<img class="sp-only" data-rellax-speed="1.5" src="images/top/sp/index-kv-img-2.jpg" alt="" />
				</div>
			</div>
		...
		<div class="bg_white pos_rel"><!-- ▼ 白背景 -->
			...
			?>
				...
				<div style="height:34vw; max-height:200px; padding-top:1.25em; overflow:hidden;">
			...
			<div class="mgnAuto top_bnrbox">
				...
				?>
				<div class="LH200 sp_textL mgnLR50 mgnLR0_sp" style="padding-top:1em; padding-bottom:2em;"><?php echo WORD_BR('デュープレジデンスは、たった2家族だけのプライベート感溢れる、1棟2戸のメゾネットマンション。' . $pad . '駅近エリアに限定したコンパクトな住まいは、リーズナブルな価格とランニングコストの負担を抑えることで、<br class="sp_vanish">ゆとりある快適かつ上質な都市生活を実現します。' . $pad . 'お2人様ぐらいにちょうどいいサイズで、世代を問わず幅広いニーズに応える、新しいカタチの住まいです。'); ?></div>
				<?php
			...
			<div class="top_news">
				<div class="box">
					<div class="title LH100"><span class="LS0_1em">NEWS</span>
						<div class="mini font_meiryo">お知らせ</div>
					</div>
...
*/
					...
					<table border="0" cellpadding="0" cellspacing="0" class="slide_box borderbox">
						<tr>
							<td align="center" valign="top" class="arrow">
								<div class="btn_prev" move="1"></div>
							</td>
							<td align="left" valign="top" class="menu">
								<div class="pos_rel">
									<ul<?php echo (($cnt >= 2) ? ' class="loop"' : ''); ?>>
										<?php
										if ($cnt >= 2) {
											echo $slide_str . $slide_str . $slide_str;
										} else {
											echo $slide_str;
										}
										?>
...
*/
				...
				<div class="textC" style="margin-top:20px; margin-bottom:70px; padding: 0 20px;">
					...
					<?php echo BTN_OVAL('物件情報', '全ての物件はこちら', 'width:600px;', 'colorR font_min'); ?>
				</div>
				<!-- *** -->
			<?php
			} //if(false)
...
*/
	...
	<script>
		function checkBreakPoint() {
			...
			if (w <= 767) {
				// スマホ向け（767px以下のとき）
				$(".index-kv__list").not(".slick-initialized").slick({
					//スライドさせる
					arrows: false,
					autoplay: true,
					fade: true,
				...
				// PC向け
				$(".index-kv__list.slick-initialized").slick("unslick");
			}
		}
		// ウインドウがリサイズする度にチェック
